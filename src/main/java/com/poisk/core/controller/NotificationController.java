...
import com.poisk.core.service.NotificationService;
...
public class NotificationController {
	...
	@PreAuthorize("hasAnyRole('ROLE_USER', 'ROLE_ADMIN')")
	@GetMapping(path = "/{id}")
	public ResponseEntity<Notification> findOne(@PathVariable Integer id) {
		Notification notification = notificationService.findOne(id);
		return new ResponseEntity<>(notification, HttpStatus.OK);
	}
	
	@PostMapping(path = "/survey/{surveyId}")
    public ResponseEntity<Notification> saveSurveySubmit(@PathVariable("surveyId") Integer surveyId) {
    ...
    public ResponseEntity<Notification> saveSurveyReport(@PathVariable("surveyId") Integer surveyId) {
        Survey completedSurvey = surveyService.findOne(surveyId);
    ...
    public ResponseEntity<Notification> saveCommentSubmit(@PathVariable("commentId") Integer commentId) {
    ...
    public ResponseEntity<Notification> saveCommentReport(@PathVariable("commentId") Integer commentId) {
        Comment comment = commentService.findOne(commentId);
	...
	@PreAuthorize("hasAnyRole('ROLE_USER', 'ROLE_ADMIN')")
	@DeleteMapping
	public ResponseEntity<Object> delete(@PathVariable Integer notificationId) {
	...
	private void notifyByEmail(User user, Notification notification) {		
        ...
        mail.setSubject("Survey | " + notification.getReceiver() + " | Notification");
